<template>
    <div class="flex flex-col items-center justify-center py-20 text-textSlate400 animate-pulse" v-if="UserStore.tarefas.length === 0">
    ...
    :key="tarefa.id" @click="tarefa.completed = !tarefa.completed" :class="['flex justify-between mb-8  rounded-2xl p-4 shadow-md border text-textBW border-textSlate300 transition-all duration-300 hover:scale-[1.01]', tarefa.completed ? 'bg-emerald-400 opacity-70' : 'bg-branco']">
